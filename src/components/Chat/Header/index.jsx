...
const Header = () => {
    ...
    const isAnyChatSelected = Object.keys(getSelectedChat).length > 0 ? true : false
                ...
                <>
                    <div className="flex py-2">
                        <div className="relative inline-block">
                            <img className="inline-block object-cover w-12 h-12 rounded-full" src={getSelectedChat.contact.avatar} alt="Avatar" />
                            <span className="absolute bottom-0 right-0 inline-block w-3 h-3 bg-green-600 border-2 border-white rounded-full"></span>
                        </div>
                        <div className="flex flex-col ml-2">
                            <span className="text-normal text-left text-gray-700">{getSelectedChat.contact.name}</span>
                            <span className="text-sm text-left text-gray-500">{getSelectedChat.contact.subname}</span>
                        </div>
                    </div>
