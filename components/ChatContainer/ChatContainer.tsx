  ...
  return (
    <>
      <Flex w="full" alignItems="flex-start">
        <VStack bg="#FAFAFE" w="md" h="full" px={4} alignItems="flex-start">
      ...
      <Modal onClose={() => null} size="full" isOpen={isOpen}>
        <ModalContent bg="rgba(255, 255, 255, 0.4)" backdropFilter="blur(5px)">
          <ModalBody
            display="flex"
            w="full"
            h="100vh"
            ...
            alignItems="center"
          >
            <Button boxShadow="lg" colorScheme="gray" onClick={toggleColorMode}>
